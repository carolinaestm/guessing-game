  ...
  do {
    ...
    case displayLeft:
      ...
      // stop them from seeing both numbers
        ...
        cout << "You have already displayed a number. You cannot display "
                "both"
             << endl;
        cout << num1 << "  " << num2 << endl;
      }
    ...
    case guess:
      ...
      if (guess >= left && guess <= right) {
        ...
        // adding points if user did not display either number and printing
        // total points
        if (num1 == -1 && num2 == -1) {
          points += 5;
        ...
        // adding a point if user did display either number and printing total
        // points
        else {
          points += 1;
      ...
      // user guessed incorrectly
        ...
        // subtracting points if user did not display either number and printing
        // total points
        if (num1 == -1 && num2 == -1) {
          points -= 5;
          ...
          // subtracting 10 points if user did display either number and
    ...
    default:
      ...
      break;
           ...
           points >= 0); // breaks the loop if user exits or runs out of points
